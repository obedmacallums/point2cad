  ...
  return (
    <div className="h-full p-4 sm:p-6">
      <div
        ...
        className={`flex flex-col items-center justify-center h-full w-full gap-4 rounded-2xl border-2 border-dashed cursor-pointer transition-colors select-none ${
          isDragging
